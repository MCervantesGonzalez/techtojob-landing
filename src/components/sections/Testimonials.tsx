      ...
      <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
        <div className="mb-12 text-center">
          <div className="relative inline-block cursor-pointer transition-all duration-300 ease-out hover:-rotate-1 hover:-translate-y-1 group">
            ...
            <div className="mt-4 bg-brand-white border-2 border-brand-dark shadow-[4px_4px_0px_0px_#2f3436] p-6 sm:p-8  text-center text-brand-dark max-w-3xl mx-auto transition-all duration-300 hover:shadow-[8px_8px_0px_0px_#2f3436]">
